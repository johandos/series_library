...
?>
    ...
    <div class="col-6">
        <a class="btn btn-primary" href="platforms/create">Crear Director</a>
    </div>
    <section>
        <h2>Usuarios</h2>
        <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Platform">
                            <a class="btn btn-success" href="platforms/edit?id=<?php echo $director->getId();?>">Editar</a>
                            &nbsp;&nbsp;
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ¿Esta seguro de eliminar la plataforma <?php echo $director->getName(); ?>?
                                        </div>
