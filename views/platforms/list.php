...
<div class="container">
    <div class="row">
        ...
        <div class="col-6">
            <a class="btn btn-primary" href="/platform/create">Crear plataformas</a>
        </div>
        <div class="col-12">
            <?php
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Platform">
                                    <a class="btn btn-success" href="/platform/edit?id=<?php echo $platform->getId();?>">Editar</a>
                                    &nbsp;&nbsp;
                                    <form name="delete_platform" action="/platform/delete" method="POST" style="display: inline;">
